...
//        String cr = FileUtil.readFileToString(new File(filePath + "crane.txt")).toString();
        String cr = FileUtil.readFileToString(new File("toTempData/crane.txt")).toString();
...
//        List<PreStowageData> resultList = GeneratePreStowageFromKnowStowage6.getPreStowageResult(preStowageDataList);
        List<PreStowageData> resultList = GenerateMoveOrder2.generateMoveOrder(preStowageDataList, vesselStructureInfoList);
