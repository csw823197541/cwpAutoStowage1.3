...
public class Test6_15 {
    public static void main(String[] args) {
        ...
        String vo = FileUtil.readFileToString(new File("6.15data/voyinfo.txt")).toString();

        String sh = FileUtil.readFileToString(new File("6.15data/vslstr.txt")).toString();
...
//        //属性组
        ...
        //实配图
        String pr = FileUtil.readFileToString(new File("6.15data/perstowandstow.txt")).toString();
